...
title_template = PromptTemplate(
    input_variables=["topic"], template="write me a tweet about {topic}"
)
...
# Llms
llm = OpenAI(model_name="text-davinci-003", temperature=0.9)  # type: ignore
...
# streamlit run aigc/twitter_generate.py
